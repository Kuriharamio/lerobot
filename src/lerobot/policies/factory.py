...
from .faster_pi0.configuration_faster_pi0 import FasterPI0Config
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    if name == "tdmpc":
        ...
        return PI0Policy
    elif name == "faster_pi0":
        from .faster_pi0.modeling_faster_pi0 import FasterPI0Policy

        return FasterPI0Policy
    elif name == "pi0_fast":
...
def make_policy_config(policy_type: str, **kwargs) -> PreTrainedConfig:
    ...
    elif policy_type == "faster_pi0":
        return FasterPI0Config(**kwargs)
